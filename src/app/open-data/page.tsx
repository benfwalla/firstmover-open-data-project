...
const monthlyData = [
  { month: 'July 2026', file: '2026-07.csv', count: 25624 },
  { month: 'June 2026', file: '2026-06.csv', count: 25678 },
...
export default function OpenDataPage() {
  const datasetJsonLd = {
    ...
    temporalCoverage: monthlyData.length
      ? `${monthlyData[monthlyData.length - 1].file.replace('.csv', '')}/${monthlyData[0].file.replace('.csv', '')}`
      : undefined,
    spatialCoverage: {
      '@type': 'Place',
