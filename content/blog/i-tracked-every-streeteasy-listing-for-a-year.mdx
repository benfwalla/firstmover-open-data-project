---
title: "I Tracked Every New StreetEasy Listing for a Year. Here's What I Found."
description: "277,701 rental listings. 15 months of data. Every neighborhood, every price point, every bedroom count. I built a tracker that watches StreetEasy around the clock — here's what the data actually looks like."
date: "2026-03-17"
type: blog
...
In early January 2025, I started tracking every new rental listing that appeared on StreetEasy. Every studio, every penthouse, every sketchy basement apartment with "natural light" in the description. The tracker runs continuously — when a new listing goes up, we grab it.
...
## The seasonal curve is real, and it's dramatic
...
A few things that jumped out after staring at this data:

**Bushwick's dominance.** I knew it was a big rental market, but the sheer volume — 12,620 listings, more than any Manhattan neighborhood — puts it in a category of its own. That's a neighborhood with massive turnover.

**The November dead zone.** 11,139 listings. If you're looking for leverage in negotiations, November might be when you have the most. Landlords listing that month aren't doing it for fun.

**Vinegar Hill pricing.** A neighborhood most New Yorkers couldn't point to on a map has a median rent higher than NoMad, Soho, and West Chelsea.

**The 35-bedroom apartment.** I know I said I wouldn't investigate, but it lives rent-free in my head (unlike its $13,800/month asking price).

**How few large apartments exist.** Under 3% of listings are 4-bedrooms. Families looking for space in NYC aren't just competing on price — they're competing for units that barely exist.
