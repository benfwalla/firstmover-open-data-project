...
## The sweet spot is March through April
...
Here's what I'd actually do, based on this data:
...
The conventional wisdom about NYC apartment timing isn't wrong, exactly. It's just imprecise. "Search in winter for deals" is true, but the real answer is more like: search in March for the best balance of inventory and price, check on Tuesdays around lunch, and know that the $600/month summer premium is real. That's the difference between advice and data.
